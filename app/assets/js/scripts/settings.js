        ...
        val.onclick = (e) => {
            ...
            if (Object.keys(ConfigManager.getAuthAccounts()).length === 1) {
                ...
                setOverlayContent(
                    ...
                    'UzushikaLauncherを使うためには、最低1個のアカウントにログインしている必要があります。<br>ログアウトしたら、もう一度ログインしないといけなくなります。<br><br>本当にログアウトする？',
                    '分かってるよそんなこと',
                    'やっぱやめとく'
                )
                setOverlayHandler(() => {
...
function populateReleaseNotes() {
    $.ajax({
        url: 'https://github.com/UzushikaMinecraft/launcher/releases.atom',
        success: (data) => {
