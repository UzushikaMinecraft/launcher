...
// UzushikaLauncherのスキンデータパスを取得する
...
// UzushikaLauncher内のスキンのJSONを呼び出し・オブジェクトに変更
function loadSkins() {
...
// 初回時、公式スキンをUzushikaLauncherにインポートする
...
// 初回時、自分で設定したパスでをUzushikaLauncherにインポートする
...
// 公式とUzushikaLauncherJSONのmerge（同期trueの時のみ動かす）
